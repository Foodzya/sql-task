...
INSERT INTO product (name, price, quantity, description, image, category_id, brand_id) VALUES
...
INSERT INTO user_account (firstName, lastName, email, phoneNumber, role_id) VALUES
...
INSERT INTO product_category_section (section_id, category_id) VALUES
	(1, 2),
	(2, 2),
	(1, 3),
	(1, 6),
...
INSERT INTO customer_order (modifiedDate, status, user_id) VALUES 
...
INSERT INTO product_customer_order (quantity, price, product_id, order_id) VALUES
	(3, 270, 6, 3),
	(1, 90, 6, 4),
	(3, 57, 4, 1),
	(1, 41, 2, 2),
