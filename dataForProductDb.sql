...
INSERT INTO brands (name, foundationyear) VALUES 
	('Nike', 1965),
	('Adidas', 1949),
	('Puma', 1948),
	('New Balance', 1906),
...
INSERT INTO products (name, price, quantity, description, image, productcategoryid, brandid) VALUES
...
INSERT INTO users (firstname, lastname, email, phonenumber, roleid) VALUES
...
INSERT INTO productcategorysections (sectionid, categoryid) VALUES
	(1, 2),
	(2, 2),
	(1, 3),
	(1, 6),
...
INSERT INTO orders (modifieddate, status, userid) VALUES 
...
INSERT INTO productorders (quantity, price, productid, orderid) VALUES
	(3, 270, 6, 3),
	(1, 90, 6, 4),
	(3, 57, 4, 1),
	(1, 41, 2, 2),
